      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#">Payroll Service Providers</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="#">Guide to Leave Management</a></li>
            <li><a href="#">Guide to Attendance Management</a></li>
            <li><a href="#">Guide to Performance Management</a></li>
          </ul>
        </div>
        <div>
          <h4 className="font-bold mb-3">Human Maximizer Customers</h4>
          <ul className="space-y-2 text-sm mb-4">
            <li><a href="#">Maximizer Help</a></li>
